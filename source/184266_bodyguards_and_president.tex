        ...
        \begin{figure}
            \begin{columns}[t]
                \column{.2\textwidth}
                    ...
                    \onslide<3>{
                        \begin{tikzpicture}
                            \tikzstyle{vertex} = [circle, draw=black, radius=1cm]
                            \tikzstyle{cop_vertex} = [vertex, fill=blue!50]
                            \tikzstyle{rob_vertex} = [vertex, fill=red!50]
                            \tikzstyle{edge} = [black]
...
\begin{frame}{Ochroniarze i prezydent}
    Dla grafu $G$ o $n$ wierzchołkach $B\left(G\right)$ to $n-1$.
            ...
            \column{.5\textwidth}
                ...
                \onslide<1->{
                    \begin{tikzpicture}
                        ...
                        \tikzstyle{cop_vertex} = [vertex, fill=blue!50]
                        \tikzstyle{rob_vertex} = [vertex, fill=red!50]
                        \tikzstyle{cop_rob_vertex} = [vertex, fill=green!50]
                        \tikzstyle{edge} = [black]
