...
\begin{frame}{Ochroniarze i prezydent}
    \begin{proof}[Dowód cd. Przypadek 2.]
        ...
        \onslide<2->{
        W takiej sytuacji istanieje ścieżka $v_1, v_2,...,v_n$ w $G$, że $v_1$ jest okupowane przez prezydent, a $v_n = x$.
        ...
        \onslide<3->{
        Wynikiem tego działania jest otoczenie prezydent bez ochroniarza na jej wierzchołka.
        }
        \begin{example}
            \begin{columns}
                \column{.5\textwidth}
